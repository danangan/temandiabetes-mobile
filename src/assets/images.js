const Images = {
  ...
  backIcon: require('./icons/back_white.png'),
  fbIcon: require('./icons/fb_icon.png'),
  googleIcon: require('./icons/google_icon.png'),
  backgroundLogin: require('./images/login.png'),
  backgroundName: require('./images/whats_your_name.png'),
  backgroundEmail: require('./images/email.png'),
