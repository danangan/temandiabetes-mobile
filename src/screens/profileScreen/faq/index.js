...
const FaqScreen = props => (
	<View style={styles.containerStyle}>
		...
		<ScrollView>
			...
			<Text style={styles.questionStyle}>Why do we use it ?{'\n'}</Text>
			<Text style={styles.answerStyle}>
			...
			<Text style={styles.questionStyle}>Where does it come from ?{'\n'}</Text>
			<Text style={styles.answerStyle}>
			...
			<Text style={styles.questionStyle}>Where can I get some ?{'\n'}</Text>
			<Text style={styles.answerStyle}>
