...
export default class Search extends Component {
  ...
  _internalSearch = input => {
    ...
    return filter(data, item => this._depthFirstSearch(item, input));
  };
      ...
      >
        {this.state.show && (
          <View style={[styles.navWrapper, { backgroundColor }]}>
            ...
            <View
              style={[styles.nav, { height: (Platform.OS === 'ios' ? 52 : 62) + heightAdjust }]}
            >
              {!hideBack && (
                <TouchableOpacity
                  accessible
              ...
              >
                {closeButton ? (
                  ...
                  <Image
                    ...
                    tintColor={hideX || this.state.input == '' ? backgroundColor : color.red}
                    style={{
                      padding: heightAdjust / 2 + 10,
                      height: 10,
                      width: 10
