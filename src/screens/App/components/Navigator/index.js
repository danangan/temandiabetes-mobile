...
export default class Navigator extends Component {
  ...
  onPressNofiticationIcon() {
    ...
    this.openScreen('TemanDiabetes.Notification');
  }
    ...
    return (
      <View style={styles.container}>
        <TouchableOpacity
          onPress={debounce(
            () => {
              this.openScreen('TemanDiabetes.ProfileScreen');
            },
            500,
            { leading: true, trailing: false }
          )}
        >
          <Image style={styles.iconStyle} source={Menu} />
        </TouchableOpacity>
        <Text style={styles.navbarText}>Teman Diabetes</Text>
        <TouchableOpacity
          onPress={debounce(this.onPressNofiticationIcon, 500, { leading: true, trailing: false })}
        >
          <View style={styles.notificationContainer}>
            ...
            <Image style={styles.iconStyle} source={Notification} />
          </View>
        </TouchableOpacity>
      </View>
    );
