...
const DNUReactNativeManager = NativeModules.DNUReactNativeManager;
const dnuReactNativeManagerEmitter = new NativeEventEmitter(DNUReactNativeManager);
...
class DnurseView extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
  ...
  componentDidMount() {
    DNUReactNativeManager.initManager(); // init
    this.addListenerBloodTesterEvent();
  }
